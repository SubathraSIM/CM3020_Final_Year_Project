...
from src.database.database import authenticate_user, create_user, save_consent
from src.ui.check_in_page import CheckInPage
from src.ui.consent_dialog import ConsentDialog, ThankYouDialog
...
class MainWindow(QMainWindow):
    ...
    def register_user(self):
        ...
        if not create_user(full_name, username, password):
    ...
    def finish_registration(self):
        ...
        self.login_page.show_status(
            self.login_page.t("account_created_login"),
            "success",
        )
